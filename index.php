		...
		<div class="container col-lg-6">
			<div class="form-group">
				<div class="row justify-content-lg-center">
        			<div class="col-lg-4">
						<input type="search" placeholder="Inventory #" class="form-control" name=""/><br />
					</div>
					<div class="col-lg-2">
						<input class="btn" class="form-control" type="submit" name="" value="Search" />
					</div>
				</div>
				<div class="row justify-content-lg-center">	
					<div class="col-lg-4">
						<input type="search" placeholder="Employee Name" class="form-control" name=""/><br />
					</div>
					<div class="col-lg-2">
							<input class="btn" class="form-control" type="submit" name="" value="Search" />
						</div>
				...
				<div class="row justify-content-lg-center">
					<div class="col-lg-4">
						<input type="search" placeholder="MAC Address" class="form-control" name=""/><br />
					</div>
					<div class="col-lg-2">
							<input class="btn" class="form-control" type="submit" name="" value="Search" />
						</div>
...
<br/>
<div class="footer">
    <p class="footer">Inventory System &copy 2018</p>
